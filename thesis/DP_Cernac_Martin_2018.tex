...
\subsection{Tunelování skrze \texttt{DNS}}
...
\subsection{Tunelování skrze \texttt{ICMP}}
...
\subsection{Tunelování skrze protokoly transportní vrstvy}
...
\end{tikzpicture}
\caption{Sekvenční diagram navázání \texttt{UDP}/\texttt{TCP} tunelu}
